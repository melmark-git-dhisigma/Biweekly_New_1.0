<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teach_content_pagePPT.aspx.cs" Inherits="teach_content_pagePPT" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function fn_fillPage(type, slideNo) {
            $.ajax({
            ...
            <div id="dashboard-content-panel">
                ...
                <div id="dashboard-RHS">
                    ...
                    <div class="dashboard-RHS-content" style="padding: 5px; width: 810px; margin-left: 141px;">
                        ...
                        <div style="width: 810px; min-height: 490px; background-color: #EAEAEA;">
...
<script type="text/javascript">
    ...
    $('.rightSlider').click(function () {
        $('#workSpace').empty();
        var sNo = parseInt(slideNo);
        sNo++;
        fn_fillPage(type, sNo);
        slideNo = sNo;
    });
