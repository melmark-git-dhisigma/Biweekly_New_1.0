<%@ Page Language="C#" AutoEventWireup="true" CodeFile="matchingLessons.aspx.cs" Inherits="matchingLessons" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function fn_renamer(S_No, value, control) {
            $.ajax({
                url: "matchingLessons.aspx/rename",
        ...
        <div id="db-container">
            ...
            <div id="dashboard-RHSVin">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td rowspan="2" style="vertical-align: top; width: 20px;">
                        ...
                        <td style="width: 20%; border: 3px solid #E8E8E8; padding: 10px;">
                                                ...
                                                <tr>
                                                    <td style="width: 42%;">
                                                        <div class="elemOption">
                                                            <asp:ImageButton runat="server" ID="optImage" Style="padding-right: 10px; padding-left: 20px;" ToolTip="Images" ImageUrl="~/VisualTool/images/image1.JPG" OnClick="optImage_Click" />
                                                        </div>
                                                        <div class="elemOption">
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:TextBox ID="TextBox1" runat="server" style="width:100px;" CssClass="searchTextBox" value="Search File name" onBlur="if(this.value=='') this.value='Search File name'" autocomplete="off" onFocus="if(this.value =='Search File name' ) this.value=''" Width="120px"></asp:TextBox>
                                                    </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_finish').click(function () {
            ...
            var thisMusic = "";
            if ($('.ml_questionTemplate').find('.player').length > 0) {

                thisMusic = $('.ml_questionTemplate').find('.player').html();
            }
            ...
            details = details + '<div class="music">' + thisMusic + '</div>';
    ...
    function fn_getAllLeOptIds() {
        ...
        $.ajax({
            url: "matchingLessons.aspx/getLeOptId",
            data: "{}",
            dataType: "json",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            ...
            success: function (data) {
                ...
                for (i = 0; i < optL.length - 1 ; i++) {
                    ...
                    //alert('subOptList[1]:' + subOptList[1]);
                    //alert('i:' + parseInt(i) + ' optL.length - 2:' + parseInt(optL.length - 2));
                ...
                var distList = $('.distractorContainer').find('.distTemplateSmall');

                if (distList.length > 0) {
                    fn_distClick($(distList[distList.length - 1]));
                }
    ...
    function fn_fillQuestion(leOptId) {
        $.ajax({
            url: "matchingLessons.aspx/getTempData",
            ...
            success: function (data) {
                ...
                var new_musicFile = "";
                var all_contents = $(recContentArray[0]);

                if (recContent.indexOf("System.IndexOutOfRangeException") == -1) {

                    

                    var listNew = $(all_contents).find('.saveElem');
                    var lblContent = $(all_contents).find('.label').html();
                    new_musicFile = $(all_contents).find('.music').html();
                   // alert(new_musicFile);
                    var details = "<div>";
                    var W = '.ml_questionTemplate';
                    var Woff = $(W).offset();
                    ...
                    for (var i = 0; i < listNew.length; i++) {
                        ...
                        if (data != "") {
                            ...
                            var upBox = "<div>" + data + "</div>";
                            if ($(upBox).find('.selectable').length > 0) {

                                $(W + ' .ml_base').append('<div class = "demo" style = "height:' + height + '; width:' + width + ';top:' + top + 'px;left:' + left + 'px; position:absolute;">' + data + '</div>');
                            }
                            else {

                                $(W + ' .ml_base').append('<div class = "demo vidBox" style = "height:' + height + '; width:' + width + ';top:' + top + 'px;left:' + left + 'px; position:absolute;">' + data + '</div>');
                            }
                        }

                    }

                    $('.ml_questionTemplate .ml_base .demo').not('.vidBox').draggable({ containment: "parent" }).resizable();
                    ...
                    if (new_musicFile != "") {
                        ...
                        $('.player').empty();
                        $('.player').append(new_musicFile);

                        musicFile = new_musicFile;
                    }
                }
    ...
    function fn_getTempData(leOptId) {
        $.ajax({
            url: "matchingLessons.aspx/getAllTempData",
            data: "{'leOptId':'" + leOptId + "'}",
            dataType: "json",
            type: "POST",
            contentType: "application/json; charset=utf-8",
    ...
    function deleteDist(distId) {
        $.ajax({
            url: "matchingLessons.aspx/deleteDist",
            data: "{'distId':'" + distId + "'}",
            dataType: "json",
            type: "POST",
            contentType: "application/json; charset=utf-8",
    ...
    function fn_distClick(e) {
        ...
        $('.distTemplateSmall').css({ 'border': '1px dashed #E8E8E8' });
    ...
    function fn_addDist(dist_status) {
        $.ajax({
            url: "matchingLessons.aspx/createDist",
    ...
    function fn_saveTemp(objects, dist_status, leOptId) {
        $.ajax({
            url: "matchingLessons.aspx/saveDist",
