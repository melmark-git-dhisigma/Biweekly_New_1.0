<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coinLessons.aspx.cs" Inherits="coinLessons" %>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%;">
                                                            <div class="elemOption">
                                                                <asp:ImageButton runat="server" ID="optImage" Style="padding-right: 5px;" ToolTip="Images" ImageUrl="~/VisualTool/images/image1.JPG" OnClick="optImage_Click" />
                                                            </div>
                                                            <div class="elemOption">
                                                                <asp:ImageButton runat="server" ID="optVideo" ToolTip="Videos" Style="padding-right: 5px;" ImageUrl="~/VisualTool/images/Video1.JPG" OnClick="optVideo_Click" />
                                                            </div>
                                                            <div class="elemOption">
                                                                <asp:ImageButton runat="server" ID="optAudio" ToolTip="Audios" Style="padding-right: 5px;" ImageUrl="~/VisualTool/images/Audio.JPG" OnClick="optAudio_Click" />
                                                            </div>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="TextBox1" style="width:100px;" runat="server" CssClass="searchTextBox" value="Search File name" onBlur="if(this.value=='') this.value='Search File name'" autocomplete="off" onFocus="if(this.value =='Search File name' ) this.value=''"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (recContent.indexOf("System.IndexOutOfRangeException") == -1) {
                   ...
                   // alert($(all_contents).find('.music').html());
                    var details = "<div>";
                    var W = '.ml_questionTemplate';
                    var Woff = $(W).offset();
