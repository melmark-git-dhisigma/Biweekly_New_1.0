<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeachPage_Coin.aspx.cs" Inherits="Phase002_1_TeachPage_Coin" %>
                                ...
                                <tr>
                                    <td>
                                        <div class="heading-Board">
                                            <span class="h1Design">Coin Lesson</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (noOftries == null) {
            $.ajax({
                url: "TeachPage_Coin.aspx/getNoOfTrials",
                data: "{}",
                dataType: "json",
                type: "POST",
    ...
    function fn_getLeOptIds() {
        $.ajax({
            url: "TeachPage_Coin.aspx/getLeOptId",
            data: "{}",
            dataType: "json",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            ...
            success: function (data) {
                ...
                $('.ml_answerTemplate').click(function () {
                    ...
                    if ($(this).hasClass('C')) {
                        ...
                        //$.ajax({
                        //    url: "TeachPage_Coin.aspx/GetStepNumbrs",
                        //    dataType: "json",
                        //    type: "POST",
                        //    contentType: "application/json; charset=utf-8",
                        //    dataFilter: function (data) { return data; },
                        ...
                        //            alert('Completed');
                        //        else {
                        //            var url = "TeachPage_Coin.aspx?noofretry=3";
                        ...
                        //if (noOftries > 0) {
                        //    //alert('Enter');
                        //    var url = "TeachPage_Coin.aspx?noofretry=" + noOftries + "";
                        //    $(location).attr('href', url);
    ...
    function fn_getTempData(leOptId) {
        $.ajax({
            url: "TeachPage_Coin.aspx/getTempData",
    ...
    function ResultSaving(CrctWrng) {
        ...
        $.ajax({
            url: "TeachPage_Coin.aspx/SaveData",
                    ...
                    success: function (data) {
                        ...
                        if (data.d == 0) {
                            ...
                            $.ajax({
                                ...
                                dataFilter: function (data) { return data; },
                                success: function (data) {
                                    var url = "TeachPage_Coin.aspx?noofretry="+data.d;
                                    $(location).attr('href', url);
    ...
    function returnAnswr() {
        //var studID = 12;
        //$.ajax({
        //    url: "TeachPage_Coin.aspx/GetCorrectAns",
        //    //data: "{'studId':'" + studID + "'}",
        //    dataType: "json",
        //    type: "POST",
        //    contentType: "application/json; charset=utf-8",
