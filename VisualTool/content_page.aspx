            ...
            <div id="dashboard-content-panel">
                ...
                <div id="dashboard-RHS">
                    ...
                    <div class="dashboard-RHS-content">
                        ...
                        <div style="float: left; margin-left: -36px; padding-right: 2px;">
                            <tfoot>
                                <tr class="odd">
                                    <th colspan="8">
                                        ...
                                        <div id="btn_close" style="margin-top: 2px;" title="Close" class="with-tip">
                                            <div class="btn btn-red">
                                                <img src="images/disable-icon.png">
                                            </div>
                                        </div>
                                                ...
                                                <li id="row">
                                                    <table style="width: 100%; height: 40px;">
                                                        <tr>
                                                            ...
                                                            <td>New Row<br />
                                                                <span>Click to add a new row</span></td>
                                                        </tr>
                                                    </table>
                                                </li>
                                                <li id="video">
                                                    <table style="width: 100%; height: 40px;">
                                                        <tr>
                                                            ...
                                                            <td>Videos<br />
                                                                <span>Double click to add control</span></td>
                                                        </tr>
                                                    </table>
                                                </li>
                                                <li id="audio">
                                                    <table style="width: 100%; height: 40px;">
                                                        <tr>
                                                            ...
                                                            <td>Audios<br />
                                                                <span>Click to add an audio</span>
                                                ...
                                                <li id="text">
                                                    <table style="width: 100%; height: 40px;">
                                                        <tr>
                                                            ...
                                                            <td>Text<br />
                                                                <span>Double click to add texts</span>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (edit == '1') {
            ...
            $.ajax({
                url: "content_page.aspx/getSlideDatas",
                ...
                success: function (data) {
                    ...
                    //alert(contents);
                    try {
                        $('#workSpace').html(content_array[0]);
        ...
        $('#btn_preview').click(function () {
            if (save == true) {
                $('.fullOverlay').fadeIn('slow', function () {
                    //showHtml();
                    $('#previewFrame').attr('src', 'previewPage.aspx?pageNo=1');
                    $('#previewBoard').fadeIn();
                    $('#textEditorDiv').hide();
            ...
            if (selected) {
                if ($(selected).children().not('.ui-resizable-handle').length <= 0) {
                    if ($(selected).hasClass('dropable')) {
                        var videoElement = '<div class="selectable videoDiv" style="padding:3px;"><object type="application/x-shockwave-flash" data="Repository/videos/player_flv_maxi.swf" width="320" height="240"><param name="wmode" value="transparent" /><param name="movie" value="player_flv_maxi.swf" /><param name="FlashVars" value="flv=123.flv" /></object></div>';
        ...
        $('#btn_vidPropDone').click(function () {
            ...
            var videoElement = '<object type="application/x-shockwave-flash" data="Repository/videos/player_flv_maxi.swf" width="' + width + '" height="' + height + '"><param name="movie" value="player_flv_maxi.swf" /><param name="wmode" value="transparent" /><param name="FlashVars" value="flv=' + selectedVideo + '" /></object>';
            $(selected).empty();
            $(selected).append(videoElement);
    ...
    function saveFn() {
        ...
        $.ajax({
            url: "content_page.aspx/saveFile",
