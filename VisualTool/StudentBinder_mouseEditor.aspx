<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentBinder_mouseEditor.aspx.cs" Inherits="Phase002_1_StudentBinder_mouseEditor" %>
                ...
                <div id="dashboard-RHSVin">
                    <div class="dashboard-RHS-content">
                        ...
                        <div id="mainContainer">
                            <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td width="75%">
                                        <div id="workArea" class="droppable" style="width:860px;">
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <div id="slideArea">
                        ...
                        <div id="prevBoxContainer" style="width: 100%; height: 100%;">
                            <div id="previewBox" class="web_dialog" style="top: 6%; left: 3%; display: none;">
                                <div id="signupNew">
