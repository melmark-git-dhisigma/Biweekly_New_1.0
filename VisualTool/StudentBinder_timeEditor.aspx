<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentBinder_timeEditor.aspx.cs" Inherits="Phase002_1_StudentBinder_timeEditor" %>
                ...
                <div style="background: #fff; padding: 10px; margin: 10px;">
                    ...
                    <div id="fullDivision">
                        ...
                        <div id="prevBoxContainer" style="width: 100%; height: 100%;">
                            <div id="previewBox" class="web_dialog" style="top: 5%; left: 3%; display: none;">
                                <div id="signupNew">
