...
function fillSuggest() {
    ...
    if (searchReq.readyState == 4 || searchReq.readyState == 0) {
        ...
        searchReq.open("GET", 'TemplateInit.aspx?Type=fill', true);
...
function SaveData() {
    ...
    if (searchReq.readyState == 4 || searchReq.readyState == 0) {
        ...
        searchReq.open("GET", 'TempSetDef.aspx?Type=Save', true);
        searchReq.onreadystatechange = handleSave;
        searchReq.send(null);
    }
...
function Validate() {
    ...
    for (var i = 2; i <= divCount; i++) {
        ...
        if (document.getElementById(txtName).value == "") {
            ...
            document.getElementById('tdMsg').innerHTML = "<div class='warning_box'>Some Name Fields are Missing...</div> ";
            return false;
        }       
    }
    document.getElementById('tdMsg').innerHTML = "";
...
function removeMatchText(divNo) {
    ...
    document.getElementById(txt1).value = matchVal + ',' + txtVal;
...
function getMatchToSample(divNo) {
    ...
    if (txtVal != "") {
        ...
        var matchVal = document.getElementById(txt1).value;
        if (matchVal == "name=" + txt1 + "") matchVal = "";
...
function addTextBox() {
    ...
    if (isMatch == 1) {
        newdiv.innerHTML = '<table style=\'width: 100%;\'><tr><td width=\'50%\'>Set Name</td><td><input type="text" size="30"  name="txtName' + num + '"  id="txtName' + num + '" >&nbsp; &nbsp; <a href=\'#\' target=\'_self\' onClick=\'addTextBox()\'>Add</a>&nbsp; &nbsp; &nbsp;  '
          + '<a href=\'#\' target=\'_self\' onClick=\'decCount(' + num + ')\'>Remove</a></td></tr><tr><td>Set Description </td><td><textarea   name=txtDesc' + num + ' cols=\'50\' rows=\'5\'></textarea></td></tr>'
          + '<tr><td colspan=\'2\'><div id=Match' + num + ' style=\'width:100%\'></div></td></tr>'
          + '<tr><td>Match to Sample<input name="hidUpdate' + num + '"  id="" type="hidden" value="0" /> </td><td><input type=\'text\' size="30"  ID=txtSample' + num + ' \>&nbsp; &nbsp; <a href=\'#\' target=\'_self\' onClick=\'getMatchToSample(' + num + ')\'>Add</a><input type=\'text\' style=\'visibility:hidden\' ID=txtMatch' + num + '  name=txtMatch' + num + ' \></td></tr>'
          + '</table>';
    }
    else {
        newdiv.innerHTML = '<table style=\'width: 100%;\'><tr><td width=\'50%\'>Set Name</td><td><input type="text" size="30"  name="txtName' + num + '" id="txtName' + num + '" >&nbsp; &nbsp; <a href=\'#\' target=\'_self\' onClick=\'addTextBox()\'>Add</a>&nbsp; &nbsp; &nbsp;  '
...
function UpdateTextBox(count) {
    ...
    for (var i = 0; i < count; i++) {
        ...
        if (isMatch == 1) {
            newdiv.innerHTML = '<table style=\'width: 68%;\'><tr><td width=\'50%\'>Set Name</td><td><input type="text" size="30"  name="txtName' + num + '" id="txtName' + num + '" >&nbsp; &nbsp; <a href=\'#\' target=\'_self\' onClick=\'addTextBox()\'>Add</a>&nbsp; &nbsp; &nbsp;  '
