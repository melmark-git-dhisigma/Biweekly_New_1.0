...
function addTextBoxU(type) {
    ...
    if (type == "1") {
        ...
        html = '<div id="Div' + num + '" ><div class="contentDivider" > <table width="100%"  cellspacing="0" cellpadding="0"><tr><td colspan="2"><div class="contentDividerHead1" >TO MOVE UP</div></td><td width="15%"><input name="txtType' + num + '" id="txtType' + num + '" type="text" value="1" runat="server" size="1" style="visibility:hidden;"/><input name="txtCol' + num + '" id="txtCol' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /> <input name="txtCal' + num + '" id="txtCal' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /></td> <td width="25%"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="right" width="3%"></td><td  width="3%" align="right"><a href=\'#\' target=\'_self\' onClick=\'addTextBox(1)\'>Add</a> <a href=\'#\' target=\'_self\' onClick=\'decCount(' + num + ')\'>Remove</a></td></tr></table></td> </tr><tr><td width="15%">IOA Required</td><td width="25%"><input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="0" />No</td><td width="15%">Multiteacher Required</td> <td width="25%"><input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="0" />No</td></tr><tr><td width="15%">Template Column </td><td width="25%"><div id="divColSelect' + num + '"  name="divColSelect' + num + '" >' + strResult + '</div></td><td width="15%">Consecutive Session</td> <td width="25%"><input id="rdoConsecutiveup' + num + '"  name="rdoConsecutiveup' + num + '" type="radio" value="1"  onClick="enableSession(1,' + num + ')" />Yes<input id="rdoConsecutiveup" name="rdoConsecutiveup' + num + '" type="radio" checked="checked" value="0" onClick="enableSession(2,' + num + ')" />No</td></tr><tr><td>Measure</td><td><div id="divMeasureSelect' + num + '"><select id="drpMes' + num + '" name="drpMes' + num + '" style="width: 250px" onchange="calChange(this,' + num + ');"><option value="0">----------Select Measure-----------</option></select></div></td><td>Number Of Sessions</td><td><input id="txtNoSes' + num + '" readOnly="readOnly" name="txtNoSes' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr><tr><td>Required Score </td> '
        + '<td><input name="txtReqScore' + num + '" type="text" size="34" onkeypress="return isNumberKey(event)"  /></td><td>Instance</td><td><table width="93%" cellpadding="0" cellspacing="0" ><tr><td><input Id="txtOutFirst' + num + '" name="txtOutFirst' + num + '" type="text" size="10" /></td><td>Out Of </td><td><input Id="txtOutSecup' + num + '" name="txtOutSecup' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr></table></td></tr></table></div></div> ';
        ...
        html = '<div id="Div' + num + '" ><div class="contentDivider" ><table width="100%"  cellspacing="0" cellpadding="0"><tr><td colspan="2"><div class="contentDividerHead2" >TO MOVE DOWN</div></td><td width="15%"><input name="txtType' + num + '" id="txtType' + num + '" type="text" value="2" runat="server" size="1" style="visibility:hidden;"  /> <input name="txtCol' + num + '" id="txtCol' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /> <input name="txtCal' + num + '" id="txtCal' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /></td> <td width="25%"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="right" width="3%"></td><td  width="3%" align="right"><a href=\'#\' target=\'_self\' onClick=\'addTextBox(2)\'>Add</a> <a href=\'#\' target=\'_self\' onClick=\'decCount(' + num + ')\'>Remove</a></td></tr></table></td> </tr><tr><td width="15%">IOA Required</td><td width="25%"><input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="0" />No</td><td width="15%">Multiteacher Required</td> <td width="25%"><input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="0" />No</td></tr><tr><td width="15%">Template Column </td><td width="25%"><div id="divColSelect' + num + '"  name="divColSelect' + num + '" >' + strResult + '</div></td><td width="15%">Consecutive Session</td> <td width="25%"><input id="rdoConsecutiveup' + num + '" name="rdoConsecutiveup' + num + '" type="radio" value="1"  onClick="enableSession(1,' + num + ')" />Yes<input id="rdoConsecutiveup" name="rdoConsecutiveup' + num + '" type="radio" value="0" checked="checked" onClick="enableSession(2,' + num + ')" />No</td></tr><tr><td>Measure</td><td><div id="divMeasureSelect' + num + '"><select id="drpMes' + num + '" name="drpMes' + num + '" style="width: 250px" onchange="calChange(this,' + num + ');"><option value="0">----------Select Measure-----------</option></select></div></td><td>Number Of Sessions</td><td><input id="txtNoSes' + num + '" readOnly="readOnly" name="txtNoSes' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr><tr><td>Required Score </td> '
    + '<td><input name="txtReqScore' + num + '" type="text" size="34" onkeypress="return isNumberKey(event)"  /></td><td>Instance</td><td><table width="93%" cellpadding="0" cellspacing="0" ><tr><td><input Id="txtOutFirst' + num + '" name="txtOutFirst' + num + '" type="text" size="10" /></td><td>Out Of </td><td><input Id="txtOutSecup' + num + '" name="txtOutSecup' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr></table></td></tr></table> </div></div>';
        ...
        html = '<div id="Div' + num + '" ><div class="contentDivider" > <table width="100%"  cellspacing="0" cellpadding="0"><tr><td colspan="2"><div class="contentDividerHead3" >FOR MODIFICATION</div><input name="txtType' + num + '" id="txtType' + num + '" type="text" value="3" runat="server" style="visibility:hidden;" size="1" /></td><td width="15%"> <input name="txtCol' + num + '" id="txtCol' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /><input name="txtCal' + num + '" id="txtCal' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /></td> <td width="25%"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="right" width="3%"></td><td  width="3%" align="right"><a href=\'#\' target=\'_self\' onClick=\'addTextBox(3)\'>Add</a> <a href=\'#\' target=\'_self\' onClick=\'decCount(' + num + ')\'>Remove</a></td></tr></table></td> </tr><tr><td width="15%">IOA Required</td><td width="25%"><input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="0" />No</td><td width="15%">Multiteacher Required</td> <td width="25%"><input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="0" />No</td></tr><tr><td width="15%">Template Column </td><td width="25%"><div id="divColSelect' + num + '"  name="divColSelect' + num + '" >' + strResult + '</div></td><td width="15%">Consecutive Session</td> <td width="25%"><input id="rdoConsecutiveup' + num + '" name="rdoConsecutiveup' + num + '" type="radio" value="1"  onClick="enableSession(1,' + num + ')" />Yes<input id="rdoConsecutiveup" name="rdoConsecutiveup' + num + '" type="radio" value="0"  checked="checked" onClick="enableSession(2,' + num + ')" />No</td></tr><tr><td>Measure</td><td><div id="divMeasureSelect' + num + '"><select id="drpMes' + num + '" name="drpMes' + num + '" style="width: 250px" onchange="calChange(this,' + num + ');"><option value="0">----------Select Measure-----------</option></select></div></td><td>Number Of Sessions</td><td><input id="txtNoSes' + num + '" readOnly="readOnly" name="txtNoSes' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr><tr><td>Required Score </td> '
...
function enableSession(type, Id) {
    ...
    var xs2 = document.getElementsByName(txtSess);
    var txt2 = "txtOutSecup" + Id;
    var xs3 = document.getElementsByName(txtSess);
...
function addTextBox(type) {
    ...
    + '<td><input name="txtReqScore' + num + '" type="text" size="35" onkeypress="return isNumberKey(event)"  /></td><td>Instance</td><td><table width="93%" cellpadding="0" cellspacing="0" ><tr><td><input Id="txtOutFirst' + num + '" name="txtOutFirst' + num + '" type="text" size="10" /></td><td>Out Of </td><td><input Id="txtOutSecup' + num + '" name="txtOutSecup' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr></table></td></tr></table></div></div> ';
        ...
        html = '<div id="Div' + num + '" ><div class="contentDivider" ><table width="100%"  cellspacing="0" cellpadding="0"><tr><td colspan="2"><div class="contentDividerHead2" >TO MOVE DOWN</div></td><td width="15%"><input name="txtType' + num + '" id="txtType' + num + '" type="text" value="2" runat="server" size="1" style="visibility:hidden;"  /> <input name="txtCol' + num + '" id="txtCol' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /> <input name="txtCal' + num + '" id="txtCal' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /></td> <td width="25%"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="right" width="3%"></td><td  width="3%" align="right"><a href=\'#\' target=\'_self\' onClick=\'addTextBox(2)\'>Add</a> <a href=\'#\' target=\'_self\' onClick=\'decCount(' + num + ')\'>Remove</a></td></tr></table></td> </tr><tr><td width="15%">IOA Required</td><td width="25%"><input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="0" />No</td><td width="15%">Multiteacher Required</td> <td width="25%"><input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="0" />No</td></tr><tr><td width="15%">Template Column </td><td width="25%"><select id="select" name="tempCol' + num + '" onchange="colChange(this,' + num + ');" style="width: 250px">' + strResult + '</select></td><td width="15%">Consecutive Session</td> <td width="25%"><input id="rdoConsecutiveup' + num + '" name="rdoConsecutiveup' + num + '" type="radio" value="1" onClick="enableSession(1,' + num + ')" />Yes<input id="rdoConsecutiveup' + num + '" name="rdoConsecutiveup' + num + '" checked="checked"  type="radio" value="0" onClick="enableSession(2,' + num + ')" />No</td></tr><tr><td>Measure</td><td><div id="divMeasureSelect' + num + '"><select id="drpMes' + num + '" name="drpMes' + num + '" style="width: 250px" onchange="calChange(this,' + num + ');"><option value="0">----------Select Measure-----------</option></select></div></td><td>Number Of Sessions</td><td><input id="txtNoSes' + num + '" name="txtNoSes' + num + '" readOnly="readOnly" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr><tr><td>Required Score </td> '
    + '<td><input name="txtReqScore' + num + '" type="text" size="35" onkeypress="return isNumberKey(event)"  /></td><td>Instance</td><td><table width="93%" cellpadding="0" cellspacing="0" ><tr><td><input Id="txtOutFirst' + num + '" name="txtOutFirst' + num + '" type="text" size="10" /></td><td>Out Of </td><td><input Id="txtOutSecup' + num + '" name="txtOutSecup' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr></table></td></tr></table> </div></div>';
        document.getElementById('newMoveDown').innerHTML = document.getElementById('newMoveDown').innerHTML + html;
        numi.value = num;
    }
        ...
        html = '<div id="Div' + num + '" ><div class="contentDivider" > <table width="100%"  cellspacing="0" cellpadding="0"><tr><td colspan="2"><div class="contentDividerHead3" >FOR MODIFICATION</div><input name="txtType' + num + '" id="txtType' + num + '" type="text" value="3" runat="server" style="visibility:hidden;" size="1" /></td><td width="15%"> <input name="txtCol' + num + '" id="txtCol' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /><input name="txtCal' + num + '" id="txtCal' + num + '" type="text" value="0" size="1" style="visibility:hidden;"  /></td> <td width="25%"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="right" width="3%"></td><td  width="3%" align="right"><a href=\'#\' target=\'_self\' onClick=\'addTextBox(3)\'>Add</a> <a href=\'#\' target=\'_self\' onClick=\'decCount(' + num + ')\'>Remove</a></td></tr></table></td> </tr><tr><td width="15%">IOA Required</td><td width="25%"><input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoIOA" name="rdoIOA' + num + '" type="radio" value="0" />No</td><td width="15%">Multiteacher Required</td> <td width="25%"><input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="1" checked="checked" />Yes<input id="rdoMTeacher" name="rdoMTeacher' + num + '" type="radio" value="0" />No</td></tr><tr><td width="15%">Template Column </td><td width="25%"><select id="select" name="tempCol' + num + '" style="width: 250px" onchange="colChange(this,' + num + ');" >' + strResult + '</select></td><td width="15%">Consecutive Session</td> <td width="25%"><input id="rdoConsecutiveup' + num + '" name="rdoConsecutiveup' + num + '" onClick="enableSession(1,' + num + ')" type="radio" value="1"  />Yes<input id="rdoConsecutiveup' + num + '" name="rdoConsecutiveup' + num + '" type="radio" value="0" checked="checked"  onClick="enableSession(2,' + num + ')" />No</td></tr><tr><td>Measure</td><td><div id="divMeasureSelect' + num + '"><select id="drpMes' + num + '" name="drpMes' + num + '" style="width: 250px" onchange="calChange(this,' + num + ');"><option value="0">----------Select Measure-----------</option></select></div></td><td>Number Of Sessions</td><td><input id="txtNoSes' + num + '" readOnly="readOnly" name="txtNoSes' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr><tr><td>Required Score </td> '
    + '<td><input name="txtReqScore' + num + '" type="text" size="35" onkeypress="return isNumberKey(event)"  /></td><td>Instance</td><td><table width="93%" cellpadding="0" cellspacing="0" ><tr><td><input Id="txtOutFirst' + num + '" name="txtOutFirst' + num + '" type="text" size="10" /></td><td>Out Of </td><td><input Id="txtOutSecup' + num + '" name="txtOutSecup' + num + '" type="text" size="10" onkeypress="return isNumberKey(event)"  /></td></tr></table></td></tr></table></div></div> ';
        document.getElementById('newMoveMod').innerHTML = document.getElementById('newMoveMod').innerHTML + html;
        numi.value = num;
    }
