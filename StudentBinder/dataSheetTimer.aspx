<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dataSheetTimer.aspx.cs" Inherits="StudentBinder_dataSheetTimer" %>
...
<head id="Head1" runat="server">
  ...
  background-image: linear-gradient(to bottom, #eeeeee, white 25px);*/
    ...
    <script type="text/javascript">
        ...
        //function setTimeEvent(el, behId) {
        //    var time1 = $(el).text();
        //    alert(behId);
        //    //var f=$('.current').text();
        //    //alert("f:" + f);
        //    var splitTime = time1.split(':');
        //    var splitFormat = time1.split(' ');
        //    var splitHr = splitTime[0];
        //    var splitMinTemp = splitTime[1].split(' ');
        //    var splitMin = splitMinTemp[0];
        //    var splitAmPm = (splitFormat[1] == 'AM') ? '0' : '1';

        //    $('#txtTimeHr' + behId).val(splitHr);
        //    $('#txtTimeMin' + behId).val(splitMin);
        //    $('#txtTimeSec' + behId).val("00");
        //    $('#drpTimeAmPm' + behId).val(splitAmPm);
        //    alert("txtTimeHr--- " + txtTimeHr + "txtTimeMin----- " + txtTimeMin);
        //}
                ...
                if (Interval[BehavCount] == "" || Period[BehavCount] == "") {
                    ...
                    if (behavType[BehavCount] == 'Duration') {
                        ...
                        $('#tabs').append('   <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                            ...
                            //start
                            + '<h4 style="width:95px;font-size:12px;float:left">Duration</h4>'
                            ...
                            //start
                            + '<div>'
                            + '<h4 style="width:95px;font-size:12px;float:left">Event Time</h4>'
                           ...
                           + '<div id="divTimeEvt' + ulId[BehavCount] + '" class="divTimeEvt" style="width:100%;min-width:147px;width: 147px; height: 45px; border: 4px solid rgb(96, 198, 88); display: none; border-radius: 10px; font-weight: bold; font-size: 22px;">'
                            ...
                            + '<input maxLength="2" id="txtTimeHr' + ulId[BehavCount] + '" value="0" class="txtTime timeEvent" style="width:26px;border:0px;text-align:center;" type="text"/>:'
                            ...
                            + '<select id="drpTimeAmPm' + ulId[BehavCount] + '"  class="txtTime timeEvent" style="text-align: right; width: 47px; height: 30px; font-size: 12px;" type="select"><option value="0">AM</option><option value="1">PM</option></select>'
                             + '</div>'
                            + '</div>'
                            //end
                            + '</div>'
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           // + '<input type="checkbox" id="chkTOE' + ulId[BehavCount] + '" class="editTOE"  onclick="editTOE(this)"/>Edit'
                            ...
                            + '<input type="text" id="txtTOE' + ulId[BehavCount] + '" class="TOE_timer" style="border: 3px solid green; width: 90%;"/>'
                           // + '<input type="text" id="txtTOE_M' + ulId[BehavCount] + '" class="TOE_edit" style="border: 3px solid green; width: 90%;display:none;"/>'
                           + '<div id="divTimeEvt' + ulId[BehavCount] + '" class="divTimeEvt" style="width:100%;min-width:147px;width: 147px; height: 45px; border: 4px solid rgb(96, 198, 88); display: none; border-radius: 10px; font-weight: bold; font-size: 22px;">'
                            + '<input maxLength="2" onKeyPress="return isNumberTimeHr(event);"  id="txtTimeHr' + ulId[BehavCount] + '" value="0" class="txtTime timeEvent" style="width:26px;border:0px;text-align:center;" type="text"/>:'
                            + '<input maxLength="2" onKeyPress="return isNumberTimeMin(event);"   id="txtTimeMin' + ulId[BehavCount] + '" value="0" class="txtTime timeEvent" style="width:26px;border:0px;text-align:center;" type="text"/>:'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:420px; text-align:center; border: 0px;">'
                            + '<b><input type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                            ...
                            + '<div>'//start
                            + '<div id="divYesOrNo">'
                            + '<input type="button" id="btnYes' + ulId[BehavCount] + '" class="btnNothingClick" onclick="btnYesClicked(' + ulId[BehavCount] + ');" value="Yes">'
                            + '<input type="button" id="btnNo' + ulId[BehavCount] + '" class="btnNothingClick" onclick="btnNoClicked(' + ulId[BehavCount] + ');" value="No">'
                            + '</div>'
                            + '</div>'//end
                            + '</div>'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:490px; text-align:center; border: 0px;">'
                            + '<b><input type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('   <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           // + '<input type="checkbox" id="chktimer' + ulId[BehavCount] + '" onclick="chktimerchanged(this,' + ulId[BehavCount] + ');">Edit'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:340px;text-align:center; border: 0px;">'
                            + '<b><input type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           + '"name="" type="button" class="btnFrq"  value="Count" onclick="count(this)" />'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:370px; text-align:center; border: 0px;">'
                            + '<b><input type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           // + '<input type="checkbox" id="chkTOE' + ulId[BehavCount] + '" class="editTOE" onclick="editTOE(this)"/>Edit'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:200px; text-align:center; border: 0px;">'
                            + '<b><input type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           + '<div id="divTimeEvt' + ulId[BehavCount] + '" class="divTimeEvt" style="width:100%;min-width:147px;width: 147px; height: 45px; border: 4px solid rgb(96, 198, 88); display: none; border-radius: 10px; font-weight: bold; font-size: 22px;">'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:295px; text-align:center; border: 0px;">'
                            + '<b><input type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                    ...
                    if (behavType[BehavCount] == 'Duration') {
                        ...
                        $('#tabs').append('   <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           // + '<input type="checkbox" id="chktimer' + ulId[BehavCount] + '" onclick="chktimerchanged(this,' + ulId[BehavCount] + ');">Edit'
                            ...
                            + '<input type="text" id="txtTOE' + ulId[BehavCount] + '" class="TOE_timer" onclick="timerFunction();" style="border: 3px solid green; width: 90%; display:none;"/>'
                            + '<input type="hidden" id="hdnTOE_' + ulId[BehavCount] + '" class="hdnTOE"/>'
                             + '<input type="hidden" id="hdnFirstClick_' + ulId[BehavCount] + '" value="True"/>'
                           // + '<input type="text" id="txtTOE_M' + ulId[BehavCount] + '" class="TOE_edit" style="border: 3px solid green; width: 90%;display:none;"/>'
                           ...
                           + '<input maxLength="2" onKeyPress="return isNumberTimeHr(event);"  id="txtTimeHr' + ulId[BehavCount] + '" value="0" class="txtTime timeEvent" style="width:26px;border:0px;text-align:center;" type="text"/>:'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:325px; text-align:center; border: 0px;">'
                            + '<b><input type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           // + '<input type="checkbox" id="chktimer' + ulId[BehavCount] + '" onclick="chktimerchanged(this,' + ulId[BehavCount] + ');">Edit'
                            ...
                            + '<input type="text" id="txtTOE' + ulId[BehavCount] + '" class="TOE_timer" style="border: 3px solid green; width: 90%; display:none;"/>'
                             + '<input type="hidden" id="hdnTOE_' + ulId[BehavCount] + '" class="hdnTOE"/>'
                              + '<input type="hidden" id="hdnFirstClick_' + ulId[BehavCount] + '" value="True"/>'
                           // + '<input type="text" id="txtTOE_M' + ulId[BehavCount] + '" class="TOE_edit" style="border: 3px solid green; width: 90%;display:none;"/>'
                           + '<div id="divTimeEvt' + ulId[BehavCount] + '" class="divTimeEvt" style="width:100%;min-width:147px;width: 147px; height: 45px; border: 4px solid rgb(96, 198, 88); display: none; border-radius: 10px; font-weight: bold; font-size: 22px;">'
                            ...
                            + '</div>'
                             ...
                             ///start
                            + '<div class="tabContent4" style="top:455px; text-align:center; border: 0px;">'
                            + '<b><input  type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                             ...
                             //start
                           + '<div id="butSavReset" style="margin-top:35px"> <input type="button" value="Save" class="btns save savDurReset" id="saveDuraFreq,' + ulId[BehavCount] + '">'
                           + '<input type="button" value="Reset" class="btnr reset savDurReset"></div>'
                            //+ '</div>'
                            //end
                            + '</div>'
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:555px; text-align:center; border: 0px;">'
                            + '<b><input  type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('   <div><div style="height:300px;" id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:410px; text-align:center; border: 0px;">'
                            + '<b><input  type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           + '"name="" type="button" class="btnFrq"  value="Count" onclick="count(this)" />'
                            ...
                            ///start
                            + '<div class="tabContent4" style="top:430px; text-align:center; border: 0px;">'
                            + '<b><input  type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
                        ...
                        $('#tabs').append('  <div><div id="tabs-' + ulId[BehavCount] + '" class="behavCont">'
                           ...
                           + '<div id="divTimeEvt' + ulId[BehavCount] + '" class="divTimeEvt" style="width:100%;min-width:147px;width: 147px; height: 45px; border: 4px solid rgb(96, 198, 88); display: none; border-radius: 10px; font-weight: bold; font-size: 22px;">'
                            ...
                            + '</div>'
                             ...
                             ///start
                            + '<div class="tabContent4" style="top:345px; text-align:center; border: 0px;">'
                            + '<b><input  type="checkbox" id="chkIOA_' + ulId[BehavCount] + '"/> Start as IOA </b>'
                            + '</div>'
                            ///end
        ...
        function SelectBehaviorTab(valu) {
            ...
            $('#hdnchecktabchange').val('false');
                ...
                //var behaveid = $(valu).attr('id').replace('t-', '').trim(); //test
                //$('#hdnFirstClick_' + behaveId).val('True');
                //var scrTop = $('#dvTimeId_' + behaveid).scrollTop() + $('#dvTimeId_' + behaveid).find('.current').position().top;
                //$('#dvTimeId_' + behaveid).animate({ scrollTop: scrTop - 30 }, "fast");
                //}
        ...
        function saveDuration(inputBtn, thisElem) {
            ...
            var count = $(parentBox).find('.stpSeconds').text();
            ...
            // }
            //$("#saveDuraFreq").click(function () {
               // $("#chktimer").trigger("click");
            //});
            ...
            if (flag) {
                ...
                if (parseInt(stpSeconds) >= 0 && times != "") {
                    ...
                    if (clockBtnStatus == "Start") {
                        ...
                        //alert("stpSeconds1" + stpSeconds);
                        if (parseInt(stpSeconds) > 0 && times != "") {
                            //alert("stpSeconds2" + stpSeconds);
                            if (clockBtnStatus == "Start") {
                                saveDurationOther(inputBtn)
                                var time = parseInt($(thisElem).parents('.tabContent').find('.stpSeconds').html());
                                //saveTimeInDB(time, "", inputBtn);
        ...
        function saveDuraFreq(inputBtn, thisElem) {
            ...
            //$("#saveDuraFreq").click(function () {
                //alert("in fn");
            //$(thisElem).parent().parent().parent().find('.swt_lbl').trigger('click');
            //alert("after fn");
            //});
            if ($('#chkIOA_' + inputBtn).prop('checked'))
                $('#chkIOA_' + inputBtn).prop('checked', false);
        ...
        function saveDurationOther(inputBtn) {
            ...
            var time = document.getElementById('txtTOE' + behaveId).value;
            var toe1 = convStringToDateTimeFormat2(time);
