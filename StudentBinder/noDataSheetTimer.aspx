<%@ Page Language="C#" AutoEventWireup="true" CodeFile="noDataSheetTimer.aspx.cs" Inherits="StudentBinder_noDataSheetTimer" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../Administration/CSS/BehaviorScore.css" rel="stylesheet" />
    ...
    <style type="text/css">
        ...
        div.containerMain div.lftPartContainer {
            float: left;
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="containerMain">
                <div class="lftPartContainer" style="border: none;">
                ...
                <div>
                    <asp:ImageButton ID="btnRefresh" runat="server" CssClass="btnRefresh" ImageUrl="~/Administration/images/RefreshStudentBinder.png" ToolTip="Refresh" OnClientClick="RefreshPage();" />
                </div>

                <div class="rightPartContainer" style="float: right">

                    <%--//dataSheetTimer--%>
                    <iframe id="IfrmTimer" src="DatasheetTimerIpad.aspx" scrolling="no" frameborder="0" style="min-height: 615px; width: 100%;" runat="server"></iframe>
