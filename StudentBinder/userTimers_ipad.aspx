<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userTimers_ipad.aspx.cs" Inherits="StudentBinder_userTimers_ipad" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function startTimer(elem) {
            ...
            tContainer.find('.reset').unbind('click');
            tContainer.find('.reset').click(function () {

                var $el = $(this), x = 3000, originalColor = $el.css("background"), confirm = $el.hasClass('confirm');

                if (confirm == false) {
                    $el.addClass('confirm');

                    var msgDiv = '<div class="instruction" style="position: absolute; background-color: yellow; margin-right: 0px; width: 170px; height: 24px;">click again to Reset</div>';
                    $(this).parent().prepend(msgDiv);
                    ...
                    setTimeout(function () {
                        ...
                        $el.removeClass('confirm');
                        $el.parent().find('.instruction').remove();
                    }, x);
                }
                else {
                    tContainer.find('.btnStart').show();
            ...
            tContainer.find('.timDel').unbind('click');
...
<body style="margin: 0px;">
    <form id="form1" runat="server">
        ...
        <div id="addStudentTimer" style="height: 25px;" onclick="showStudents()">Add Student</div>
