<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateCustomIEP.aspx.cs" Inherits="StudentBinder_CreateCustomIEP" ValidateRequest="false" %>
    ...
    <script type="text/javascript">
        ...
        function CheckError(txtSubmit, identity) {
            ...
            if (identity == 1) {
                ...
                document.getElementById('btnIEPExport').style.display = "none";
                document.getElementById('btnUpdateandExport').style.display = "block";
            }
            else {
        ...
        function setInProgreesIEPID() {

            $.ajax(
       {
           type: "POST",
           url: "CreateCustomIEP.aspx/getInprogressIepId",
        ...
        function SetIepID(IEPID) {
            ...
            $('#' + '<%=(btnUploadBSP).ClientID %>').css("display", "none");
        }
        ...
        function CreateIEPClick() {
            ...
            $('#' + '<%=(btnUploadBSP).ClientID %>').css("display", "block");
            document.getElementById('btnapprove').style.display = "none";
        ...
        function CreateIEP1() {
            ...
            if (parseInt(iep) > 0) {
                ...
                $('#lnkBtnPlacement').attr('class', 'negative');
                $('#lnkBtnAddDataSheet').attr('class', 'negative');
                $('#lnkBtnSigPage').attr('class', 'negative');
                $('#lnkBtnAttendSheet').attr('class', 'negative');
                $('#ifrmContent').attr('src', 'CreateIEP1.aspx');
            }
            else {
                popupShow();
            }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP2.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP3.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP4.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP5.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP6.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP7.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#lnkBtnAddDataSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP8.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnStateOfDist').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#lnkBtnPlacement').attr('class', 'grmb grimgbAck');
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnAddInfo').attr('class', 'negative');
                                        $('#lnkBtnAddDataSheet').attr('class', 'negative');
                                        $('#ifrmContent').attr('src', 'CreateIEP9.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#lnkBtnPlacement').attr('class', 'negative');
                                        $('#lnkBtnAddDataSheet').attr('class', 'grmb grimgbAck');
                                        $('#ifrmContent').attr('src', 'CreateIEP10.aspx');
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnPlacement').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'negative');
                                        $('#lnkBtnSigPage').attr('class', 'grmb grimgbAck');


                                        $('#ifrmContent').attr('src', 'CreateIEP12.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                       ...
                       $.ajax(
                            {
                                ...
                                success: function (data) {
                                    ...
                                    if (parseInt(iep) > 0) {
                                        ...
                                        $('#lnkBtnSigPage').attr('class', 'negative');
                                        $('#lnkBtnPlacement').attr('class', 'negative');
                                        $('#lnkBtnAttendSheet').attr('class', 'grmb grimgbAck');
                                        $('#ifrmContent').attr('src', 'CreateIEP11.aspx');
                                    }
                                    else {
                                        popupShow();
                                    }
                ...
                success: function (data) {
                    ...
                    if (contents.indexOf("System.IndexOutOfRangeException") == -1) {
                        if (contents != "") {
                            ...
                            if (testval[8] == 'True') {
                                if ($('#lnkBtnPlacement').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnPlacement').removeClass('negative');
                                    $('#lnkBtnPlacement').addClass('gtic');
                                }
                            }
                            else {
                                if ($('#lnkBtnPlacement').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnPlacement').attr('CssClass', 'negative');
                                }
                            }

                            if (testval[9] == 'True') {
                                if ($('#lnkBtnAddDataSheet').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnAddDataSheet').removeClass('negative');
                                    $('#lnkBtnAddDataSheet').addClass('gtic');
                                }

                            }
                            else {
                                if ($('#lnkBtnAddDataSheet').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnAddDataSheet').attr('CssClass', 'negative');
                                }
                            }
                            if (testval[10] == 'True') {
                                if ($('#lnkBtnAttendSheet').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnAttendSheet').removeClass('negative');
                                    $('#lnkBtnAttendSheet').addClass('gtic');
                                }
                            }
                            else {
                                if ($('#lnkBtnAttendSheet').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnAttendSheet').attr('CssClass', 'negative');
                                }
                            ...
                            if (testval[11] == 'True') {
                                if ($('#lnkBtnSigPage').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnSigPage').removeClass('negative');
                                    $('#lnkBtnSigPage').addClass('gtic');
                                }
                            }
                            else {
                                if ($('#lnkBtnSigPage').attr('class') != 'grmb grimgbAck') {
                                    $('#lnkBtnSigPage').attr('CssClass', 'negative');
                                }
                            }
                            ...
                            <div class="boxContainerContainer">
                                ...
                                <div class="itlepartContainer">
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="width: 1%">
                                                <asp:Button ID="btndeleteIEP" runat="server" Text="Delete IEP" CssClass="NFButton" OnClick="btndeleteIEP_Click" OnClientClick="return ConfirmDelete();"></asp:Button>
                                            </td>
                                            <td id="lnkbtnSignDetal" style="width: 1%" runat="server">
                                                <%--<asp:Button ID="btnSignDetails" runat="server" Text="Sign Details" ToolTip="Sign Details" OnClick="lnkBtnSignDetails_Click" OnClientClick="showUserpop();"></asp:Button>--%>
                                                <input type="button" value="Sign Details" onclick="listUsers();" class="NFButton" />
                                            </td>
                                            <td style="width: 1%;">
                                                <asp:Button ID="btnUploadBSP" runat="server" Text="Upload BSP" CssClass="NFButton" ToolTip="Upload BSP" OnClick="btnUploadBSP_Click" Visible="false" />
                                                </td>
                                            <td style="width: 1%">
                                                <asp:Button ID="btnUpdateandExport" OnClick="btnUpdateandExport_Click" runat="server" Text="" Width="110px" CssClass="ExportWord" ToolTip="Export To Word" OnClientClick="return checkPostbackExport();"></asp:Button>
                                            </td>

                                            <td style="width: 1%">

                                                <asp:Button ID="btnIEPExport" runat="server" CssClass="ExportWord" ToolTip="Export To Word" Text="" OnClick="btnIEPExport_Click" OnClientClick="return checkPostbackExport();" style="display: none"></asp:Button>
                                            </td>
                                ...
                                <div class="btContainerPart">
                                    ...
                                    <div class="mBxContainer">
                                        ...
                                        <asp:LinkButton ID="lnkBtnIndiviEdu" runat="server" OnClientClick="return submitTheForm(1);" CssClass="negative">Individualized Education</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnPrestLvlEdu" runat="server" OnClientClick="return submitTheForm(2);" CssClass="negative">Present Levels Of Educational</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnPrestLvlEdu2" runat="server" OnClientClick="return submitTheForm(3);" CssClass="negative">Present Levels Of Educational </asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnCurPre" runat="server" OnClientClick="return submitTheForm(4);" CssClass="negative">Current Performance</asp:LinkButton>
                                        <asp:LinkButton ID="LnkBtnSerDel" runat="server" OnClientClick="return submitTheForm(5);" CssClass="negative">Service Delivery</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnNonParJus" runat="server" OnClientClick="return submitTheForm(6);" CssClass="negative">Non Participation justification</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnStateOfDist" runat="server" OnClientClick="return submitTheForm(7);" CssClass="negative">State or District-Wide</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnAddInfo" runat="server" OnClientClick="return submitTheForm(8);" CssClass="negative">Additional Information</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnPlacement" runat="server" OnClientClick="return submitTheForm(9);" CssClass="negative">Team Placement Page</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnAddDataSheet" runat="server" OnClientClick="return submitTheForm(10);" CssClass="negative">Administrative Data Sheet</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnAttendSheet" runat="server" OnClientClick="return submitTheForm(11);" CssClass="negative">Attendance Sheet</asp:LinkButton>
                                        <asp:LinkButton ID="lnkBtnSigPage" runat="server" OnClientClick="return submitTheForm(12);" CssClass="negative">Signature Page</asp:LinkButton>
                                        ...
                                        <%--<input type="button" value="Create a new version of an existing IEP" class="NFButton" style="width:auto" onclick='javascript: $("#sign_up5").show();"btnNewIEP_Click"   />--%>
                                ...
                                <asp:LinkButton ID="lnkBtnExport" runat="server" CssClass="blButton" Text="Export To Word" OnClick="lnkBtnExport_Click" OnClientClick="return checkPostbackExport();"></asp:LinkButton>
                                    ...
                                    <div class="righMainContainer large">
                                        <div class="clear">
                                            <iframe style="border-style: 0; border-width: 0px; width: 100%; overflow: hidden;" id="ifrmContent" scrolling="no" onload='javascript:resizeIframe(this);'></iframe>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        <td colspan="6">
                            <asp:Panel ID="pnl_currIEPdetails" runat="server" Visible="false" Style="text-align: center;">
                                <span>The current IEP is </span>
                                <asp:Label ID="lbl_CurrYear" runat="server" Style="font-weight: bold;" Text="20XX-20XX Version X.XX"></asp:Label>
...
FontForeColorPicker,FontBackColorsMenu,FontBackColorPicker,Bold,Italic,Underline,RemoveFormat,JustifyLeft,JustifyRight,JustifyCenter,JustifyFull;BulletedList,NumberedList"
        ...
        <div id="SignPopups" class="web_dialog" style="width: 500px; top: 1%; height: 300px; margin-left: -3%; display: none;">

            <a id="A2" class="close sprited1" href="#" style="margin-top: -5px; margin-right: 0px;">
                <img src="../Administration/images/clb.PNG" onclick="closePOP();" style="float: right; margin-right: -5px; margin-top: 0; z-index: 300" width="18" height="18" alt="" /></a>

            <div id="Div5" style="width: 100%; margin-left: 10px 0 0 0">
                <h2 style="margin: 10px;">Signed Users             <h2 style="margin: 10px;">Signed Users</h2>
                <hr />
                <table style="width: 100%">

                    <tr>
                        <td id="tdUSers" style="margin: 5px;"></td>
                    </tr>
